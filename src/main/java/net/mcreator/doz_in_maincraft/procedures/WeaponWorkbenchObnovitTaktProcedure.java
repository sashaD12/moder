...
public class WeaponWorkbenchObnovitTaktProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
			...
			if ((new Object() {
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 4) >= 1) {
				{
					...
					if (_ent != null) {
						final int _slotid = 5;
						final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.TT.get()).copy();
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 4)).getItem() == DozInMaincraftModBlocks.MAGIC_PINE_LOG.get().asItem()) {
			if ((new Object() {
				public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					BlockEntity _ent = world.getBlockEntity(pos);
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 4) >= 2) {
				{
					...
					if (_ent != null) {
						final int _slotid = 5;
						final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.L_96_A_1.get()).copy();
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
		...
		if ((new Object() {
			...
			if ((new Object() {
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 4) >= 2) {
				{
					...
					if (_ent != null) {
						final int _slotid = 5;
						final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.PP_19_BIZON.get()).copy();
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
		...
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == DozInMaincraftModItems.DETAIL_AKM.get() && (new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
			...
			if ((new Object() {
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 4) >= 2) {
				{
					...
					if (_ent != null) {
						final int _slotid = 5;
						final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.AK_47.get()).copy();
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
		...
		if ((new Object() {
		...
		}.getItemStack(world, BlockPos.containing(x, y, z), 1)).getItem() == DozInMaincraftModItems.DETAIL_SKAR_H.get() && (new Object() {
			public ItemStack getItemStack(LevelAccessor world, BlockPos pos, int slotid) {
				AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
				BlockEntity _ent = world.getBlockEntity(pos);
				if (_ent != null)
			...
			if ((new Object() {
			...
			}.getAmount(world, BlockPos.containing(x, y, z), 4) >= 3) {
				{
					...
					if (_ent != null) {
						final int _slotid = 5;
						final ItemStack _setstack = new ItemStack(DozInMaincraftModItems.SCAR_H.get()).copy();
						_setstack.setCount((int) (new Object() {
							public int getAmount(LevelAccessor world, BlockPos pos, int slotid) {
								AtomicInteger _retval = new AtomicInteger(0);
								BlockEntity _ent = world.getBlockEntity(pos);
