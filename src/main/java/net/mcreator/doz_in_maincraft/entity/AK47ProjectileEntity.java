...
public class AK47ProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public AK47ProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(DozInMaincraftModEntities.AK_47_PROJECTILE.get(), world);
	}
	...
	public static AK47ProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		AK47ProjectileEntity entityarrow = new AK47ProjectileEntity(DozInMaincraftModEntities.AK_47_PROJECTILE.get(), entity, world);
	...
	public static AK47ProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		AK47ProjectileEntity entityarrow = new AK47ProjectileEntity(DozInMaincraftModEntities.AK_47_PROJECTILE.get(), entity, entity.level());
