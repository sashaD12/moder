...
public class AptechkaMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AptechkaMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(DozInMaincraftModMenus.APTECHKA.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 61, 35) {
			...
			private int x = AptechkaMenu.this.x;
			private int y = AptechkaMenu.this.y;
